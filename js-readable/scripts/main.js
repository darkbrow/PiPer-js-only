...
const addButton$$module$button = function(parent) {
  if (!button$$module$button) {
    ...
    const buttonImageURL = `https://raw.githubusercontent.com/darkbrow/PiPer-js-only/main/toolbar/` + `${buttonImage}.svg`;
    image.src = buttonImageURL;
    if (buttonExitImage) {
      // const buttonExitImageURL = getExtensionURL$$module$common(`images/${buttonExitImage}.svg`);
      const buttonExitImageURL = `https://raw.githubusercontent.com/darkbrow/PiPer-js-only/main/toolbar/` + `${buttonExitImage}.svg`;
